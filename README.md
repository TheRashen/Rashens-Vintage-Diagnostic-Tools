...
I also study user interfaces, aswell as other nuanced everyday things and features that modern technology has for optimal user functionality, as a Game Dev and use my knowledge as a system architect to attempt to make things as visually pleasing as possible to our eyes as no one want to be hunched over scanning lines all day, especially folks who are *not* coders or in tech fields.
